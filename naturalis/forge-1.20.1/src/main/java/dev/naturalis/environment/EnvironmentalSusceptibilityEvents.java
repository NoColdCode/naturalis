...
public final class EnvironmentalSusceptibilityEvents {
    ...
    private static final ResourceLocation ADV_COLD_HARDY = new ResourceLocation(Naturalis.MOD_ID, "environment/cold_hardy");
    private static final ResourceLocation ADV_HEAT_RESISTANT = new ResourceLocation(Naturalis.MOD_ID, "environment/heat_resistant");
    private static final ResourceLocation ADV_WATERBORNE = new ResourceLocation(Naturalis.MOD_ID, "environment/waterborne");
    private static final ResourceLocation ADV_DEHYDRATED = new ResourceLocation(Naturalis.MOD_ID, "environment/dehydrated");
    private static final ResourceLocation ADV_NIGHT_STALKER = new ResourceLocation(Naturalis.MOD_ID, "environment/night_stalker");

    private static final String ENV_DATA_PREFIX = Naturalis.MOD_ID + ":env_";
    ...
    private EnvironmentalSusceptibilityEvents() {
    }
