...
public final class ScentTrailWorldRenderer {
    ...
    private static boolean shouldRender() {
        return MorphSniffClientState.isScentVisionActive() && ScentTrailClient.hasRibbonGeometry();
    }
    ...
    private static void addFlatQuad(
        ...
        consumer.vertex(matrix, (float) v0.x, (float) v0.y, (float) v0.z)
            .color(r, g, b, alpha).uv(u0, vStart).overlayCoords(overlay).uv2(light).normal(0.0F, 1.0F, 0.0F).endVertex();
        consumer.vertex(matrix, (float) v1.x, (float) v1.y, (float) v1.z)
            .color(r, g, b, alpha).uv(u0, vEnd).overlayCoords(overlay).uv2(light).normal(0.0F, 1.0F, 0.0F).endVertex();
        consumer.vertex(matrix, (float) v2.x, (float) v2.y, (float) v2.z)
            .color(r, g, b, alpha).uv(u1, vEnd).overlayCoords(overlay).uv2(light).normal(0.0F, 1.0F, 0.0F).endVertex();
        consumer.vertex(matrix, (float) v3.x, (float) v3.y, (float) v3.z)
            .color(r, g, b, alpha).uv(u1, vStart).overlayCoords(overlay).uv2(light).normal(0.0F, 1.0F, 0.0F).endVertex();
    }
}
