...
const vec3 AxisA = vec3(0.00, 0.50, 0.70);
const vec3 AxisB = vec3(0.00, 0.70, 0.30);
const vec3 AxisC = vec3(0.25, 0.20, 0.55);
const vec3 ColorA = vec3(0.22, 0.78, 0.86);
const vec3 ColorB = vec3(0.25, 0.96, 0.58);
const vec3 ColorC = vec3(0.24, 0.44, 0.96);
