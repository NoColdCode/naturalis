...
const vec3 AxisA = vec3(0.50, 0.10, 0.40);
const vec3 AxisB = vec3(0.15, 0.22, 0.63);
const vec3 AxisC = vec3(0.20, 0.62, 0.18);
const vec3 ColorA = vec3(0.74, 0.34, 0.98);
const vec3 ColorB = vec3(0.38, 0.82, 1.00);
const vec3 ColorC = vec3(0.48, 0.96, 0.72);
