...
const vec3 AxisA = vec3(0.20, 0.70, 0.10);
const vec3 AxisB = vec3(0.70, 0.25, 0.05);
const vec3 AxisC = vec3(0.20, 0.25, 0.55);
const vec3 ColorA = vec3(0.50, 0.82, 0.22);
const vec3 ColorB = vec3(0.90, 0.62, 0.18);
const vec3 ColorC = vec3(0.34, 0.52, 0.70);
