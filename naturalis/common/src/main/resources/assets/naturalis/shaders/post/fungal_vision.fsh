...
const vec3 AxisA = vec3(0.42, 0.22, 0.55);
const vec3 AxisB = vec3(0.72, 0.55, 0.12);
const vec3 AxisC = vec3(0.18, 0.62, 0.28);
const vec3 ColorA = vec3(0.82, 0.38, 0.92);
const vec3 ColorB = vec3(0.92, 0.78, 0.22);
const vec3 ColorC = vec3(0.48, 0.92, 0.42);
const float Strength = 0.86;
const float ShadowLift = 0.30;
const float LumaPreserve = 0.44;
