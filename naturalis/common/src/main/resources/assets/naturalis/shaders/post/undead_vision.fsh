...
const vec3 AxisA = vec3(0.10, 0.55, 0.35);
const vec3 AxisB = vec3(0.50, 0.40, 0.10);
const vec3 AxisC = vec3(0.12, 0.28, 0.60);
const vec3 ColorA = vec3(0.54, 0.76, 0.64);
const vec3 ColorB = vec3(0.66, 0.62, 0.46);
const vec3 ColorC = vec3(0.46, 0.64, 0.74);
const float Strength = 0.88;
const float ShadowLift = 0.20;
const float LumaPreserve = 0.48;
