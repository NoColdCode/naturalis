...
const vec3 AxisA = vec3(0.05, 0.35, 0.85);
const vec3 AxisB = vec3(0.75, 0.25, 0.05);
const vec3 AxisC = vec3(0.25, 0.75, 0.00);
const vec3 ColorA = vec3(0.50, 0.62, 1.00);
const vec3 ColorB = vec3(0.98, 0.55, 0.20);
const vec3 ColorC = vec3(0.66, 0.98, 0.34);
