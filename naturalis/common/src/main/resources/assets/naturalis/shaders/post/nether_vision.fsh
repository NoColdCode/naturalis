...
const vec3 AxisA = vec3(0.75, 0.18, 0.07);
const vec3 AxisB = vec3(0.58, 0.36, 0.06);
const vec3 AxisC = vec3(0.25, 0.12, 0.63);
const vec3 ColorA = vec3(0.96, 0.28, 0.18);
const vec3 ColorB = vec3(1.00, 0.58, 0.20);
const vec3 ColorC = vec3(0.46, 0.30, 0.74);
