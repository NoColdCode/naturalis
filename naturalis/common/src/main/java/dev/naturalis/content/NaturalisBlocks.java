...
public final class NaturalisBlocks {
    ...
    private static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(NaturalisMod.ID);

    public static final DeferredBlock<Block> ECHO_FORGE = BLOCKS.register("echo_forge",
        () -> new EchoForgeBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL)
            .strength(3.5F)
            .sound(SoundType.NETHERITE_BLOCK)
            .requiresCorrectToolForDrops()));

    public static final DeferredBlock<Block> MORPH_ARMOR_FORGE = BLOCKS.register("morph_armor_forge",
        () -> new MorphArmorForgeBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL)
            .strength(4.0F)
            .sound(SoundType.NETHERITE_BLOCK)
            .requiresCorrectToolForDrops()));

    public static final DeferredBlock<Block> NATURAL_PORTAL_FRAME = BLOCKS.register("natural_portal_frame",
        () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GREEN)
            .strength(4.0F, 1200.0F)
            .sound(SoundType.BASALT)
            .requiresCorrectToolForDrops()));

    public static final DeferredBlock<Block> NATURAL_PORTAL = BLOCKS.register("natural_portal",
    ...
    public static final DeferredBlock<Block> ECHO_BLOCK = BLOCKS.register("echo_block",
        () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_CYAN)
            .strength(2.2F)
            .sound(SoundType.AMETHYST)
            .requiresCorrectToolForDrops()));

    public static final DeferredBlock<Block> MORPH_BEACON = BLOCKS.register("morph_beacon",
