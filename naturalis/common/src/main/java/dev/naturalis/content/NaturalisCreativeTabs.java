...
public final class NaturalisCreativeTabs {
    ...
    private static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS =
        DeferredRegister.create(Registries.CREATIVE_MODE_TAB, NaturalisMod.ID);

    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> NATURALIS_TAB =
        CREATIVE_MODE_TABS.register("naturalis", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(NaturalisItems.HABIT_CHRYSALIS.get());
