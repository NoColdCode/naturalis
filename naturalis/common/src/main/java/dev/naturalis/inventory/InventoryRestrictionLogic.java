...
/**
 * Loader-neutral server tick logic for quadruped inventory / hotbar restrictions.
 */
public final class InventoryRestrictionLogic {
     ...
     */
    public static void cascadeIntoUnlockedSlots(Inventory inventory, int allowedSlots) {
    ...
    private static void clearLastSelectedSlot(ServerPlayer player) {
