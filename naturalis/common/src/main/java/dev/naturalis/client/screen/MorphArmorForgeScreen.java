...
public class MorphArmorForgeScreen extends AbstractContainerScreen<MorphArmorForgeMenu> {
    ...
    private void renderTierTooltip(GuiGraphics g, java.util.List<net.minecraft.network.chat.Component> lines, int x, int y) {
        ...
        try {
            Class<?> tooltipComponentClass = Class.forName("net.minecraft.client.gui.screens.inventory.tooltip.ClientTooltipComponent");
            java.lang.reflect.Method createMethod = tooltipComponentClass.getMethod("create", net.minecraft.util.FormattedCharSequence.class);
            java.util.List<Object> tooltipComponents = new java.util.ArrayList<>();
            for (var line : lines) {
                tooltipComponents.add(createMethod.invoke(null, line.getVisualOrderText()));
            }
            ...
            g.getClass()
                .getMethod(
                    ...
                    int.class,
                    int.class,
                    Class.forName("net.minecraft.client.gui.screens.inventory.tooltip.ClientTooltipPositioner"),
                    net.minecraft.resources.ResourceLocation.class
                )
                .invoke(g, this.font, tooltipComponents, x, y, null, null);
        } catch (ReflectiveOperationException ignored) {
            // Last-resort no-op.
        }
    }
