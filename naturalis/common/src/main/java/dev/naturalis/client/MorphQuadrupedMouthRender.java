...
/**
 * Renders the main-hand item at the morph mouth in third- and front-third-person views.
 */
public final class MorphQuadrupedMouthRender {
    ...
    /** Draw at the morph mouth when the pose stack is already in Walkers shape space (after shape render). */
    ...
    public static void render(
        ...
        render(poseStack, bufferSource, packedLight, player, shape, stack, partialTick, true);
    }
