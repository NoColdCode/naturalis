...
public final class WolfVisionClientEvents {
    ...
    public static void onClientTick(ClientTickEvent.Post event) {
        ...
        boolean scentOverlay = (MorphSniffClientState.isScentVisionActive() || ScentTrailClient.hasDeepRibbons())
            && morphId != null
        ...
        // Only compare desired vs active — do NOT separately "scentChanged" (that reloaded the
        // post chain every tick when ribbons flickered empty/full and crushed FPS to ~1).
